package com.qingting.platform.server;

import java.io.Serializable;
import java.util.Collection;
import java.util.List;

import com.qingting.platform.model.Pagination;
import com.qingting.platform.model.PersistentObject;
 ...
 * @author zlf
 */
public interface Service<T extends PersistentObject<ID>, ID extends Serializable> {
	 ...
	 * @return List<T>
	 */
	public List<T> getById(Collection<ID> pks);
